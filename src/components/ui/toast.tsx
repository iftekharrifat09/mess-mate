...
const variantIcons: Record<string, React.ReactNode> = {
  ...
  destructive: <AlertCircle className="h-5 w-5 text-[hsl(0,84%,60%)] shrink-0" />,
  warning: <AlertTriangle className="h-5 w-5 text-[hsl(45,93%,47%)] shrink-0" />,
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Close
    ref={ref}
    className={cn(
      "absolute right-2 top-2 rounded-md p-1 text-muted-foreground opacity-70 transition-opacity hover:opacity-100 focus:outline-none focus:ring-2",
      className,
    )}
    toast-close=""
    {...props}
