...
export default function ManagerRegister() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (result.success) {
      toast({
        title: 'Welcome!',
        description: 'Your mess has been created successfully.',
      });
      navigate('/dashboard');
    } else {
      toast({
    ...
    <div className="min-h-screen flex items-center justify-center bg-background p-4">
      <div className="w-full max-w-md animate-fade-in">
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground mt-2">Create your mess and start managing</p>
        </div>

        <Card className="shadow-card">
          <CardHeader className="space-y-1">
            <CardTitle className="text-2xl text-center">Create Mess</CardTitle>
            <CardDescription className="text-center">
              Register as a manager and create your mess
            </CardDescription>
          </CardHeader>
          <CardContent>
